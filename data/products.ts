...
/**
 * Eight dummy products for grids and demos (`ProductGrid` default).
 */
export const showcaseProducts: HomeProduct[] = [
  {
    id: "show-1",
    name: "Ariya Embroidered Lawn",
    price: 13990,
    category: "Lawn",
    image:
